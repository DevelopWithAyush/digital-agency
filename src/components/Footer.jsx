...
const SocialLink = ({
    ...
    return (
        <a href={href} target="_blank" rel="noreferrer" className="group">
            ...
            <Icon className="h-5 w-5 fill-zinc-500 transition group-hover:fill-zinc-900 dark:group-hover:fill-zinc-200" />
        </a>
    )
}
...
const Footer = () => {
    return (
        <div className="flex w-full flex-col items-center justify-between gap-5 border-t py-[100px] px-[5%] sm:flex-row border-white border-opacity-10 mt-[100px] md:mt-[140px] xl:mt-[200px]">
