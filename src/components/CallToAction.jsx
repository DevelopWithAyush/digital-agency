...
const CallToAction = () => {
  ...
  return (
    <section
      onMouseEnter={() => {
        setCursor({ opacity: 1, backgroundColor: "#db28ff" });
      }}
      onMouseLeave={() => {
        setCursor({ opacity: 0, backgroundColor: "#db28ff" });
      }}
      id="testimonial"
      className=" container mx-auto max-w-[88rem] overflow-hidden  relative flex flex-col items-center justify-center   px-[18px] bg-white bg-opacity-5 backdrop-blur-[25px] rounded-3xl  py-[70px] md:py-[98px] xl:py-[140px] gap-[75px] md:gap-[105px] xl:gap-[150px]"
    >
