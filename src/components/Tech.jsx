...
const Tech = () => {
  ...
  return (
    <section className="container max-w-[88rem]   mx-auto  flex flex-col   ">
      <div className="flex flex-row w-full">
        <div className=" w-1/12 flex flex-col items-center gap-2">
          ...
          <div className="w-1 h-[500px] rounded-full">
            <motion.div
              initial={{ height: "0px" }}
              whileInView={{ height: "100%" }}
              transition={{
        ...
        <div className="flex w-11/12  flex-col items-start py-[100px] md:py-[140px] xl:py-[200px] gap-[75px] ">
          <motion.div
            initial={{ opacity: 0 }}
            whileInView={{ opacity: 1 }}
            transition={{
          ...
          >
            <p className="text-[32px] md:text-[48px] lg:text-[56px] leading-[56px] font-bold">
              Technology
            </p>
            <p className="text-[24px] font-medium text-gray-500">
              That we use to grow you
            </p>
          </motion.div>
          ...
          <div className=" flex w-full  relative overflow-x-hidden ">
            <Infinitemovingcr pauseOnHover className="[--duration:20s]">
              {reviews.map((review) => (
                <Card key={review.username} review={review} />
              ))}
            </Infinitemovingcr>
...
const Card = ({ review }) => {
  return (
    <div className="w-[200px] rounded-full overflow-hidden h-[200px] bg-white text-2xl flex items-center justify-center">
