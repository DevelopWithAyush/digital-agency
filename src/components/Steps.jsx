          ...
          <div className="   grid grid-cols-12  pl-4 lg:pl-9  w-full   ">
            <div className="col-span-12 lg:col-span-6 w-full    bg-red-40    pt-12 ">
              <div className="w-full grid  grid-cols-12   ">
                <div ref={ref} className={` origin-left col-span-12 lg:col-span-8 lg:bg-white lg:bg-opacity-5 backdrop-blur-[25px] border-none lg:border-[1px] lg:border-solid border-green-400 border-opacity-10 flex items-center justify-center text-[32px] rounded-[12px] py-[0px] md:py-[0px] lg:py-12 px-[18px] md:px-[25.2px] lg:px-9 delay-500 duration-200 ${isVisible?"scale-x-100 opacity-100":"scale-x-0 opacity-0"}`}>
...
const Points = ({ point, index }) => {
  ...
  const isVisible = useElementVisibility(ref)
  return (
    <div ref={ref} className={`relative grid grid-cols-12 items-start delay-[${1+(index*0.1)}s] duration-100   w-full ${isVisible?"opacity-100 left-0":"opacity-0 left-[-50px]"}`}>
...
const UpperLine = () => {
  ...
  return (
    <div className="z-[98]  w-[2px] md:w-[3px] xl:w-[4px] h-[100px] md:h-[140px] xl:h-[200px] rounded-full">
      <div
        ref={ref}
        className={`w-[2px] md:w-[3px] xl:w-[4px]  transition-all delay-500 duration-300 rounded-full ${
...
const Emoji = () => {
  ...
  return (
    <div
      ref={ref}
      className={`relative text-[32px] leading-[32px] md:text-[48px] md:leading-[48px] xl:text-[56px] xl:leading-[56px] duration-[0.3s] delay-[0.8s] font-bold ${
...
const DownLine = () => {
  ...
  return (
    ...
    >
      <div
        className={`w-[2px] md:w-[3px] xl:w-[4px] h-[100%] delay-[1.1s] duration-[.3s] rounded-full ${
          isVisible ? "h-full" : "h-0"
        } `}
        style={{
  ...
  return (
    <p
      ...
      className={`relative text-[32px] max-w-3xl leading-[32px] md:text-[48px] md:leading-[48px] lg:text-[48px] lg:leading-[48px] xl:text-[56px] xl:leading-[56px] pl-4 duration-[0.3s] delay-[0.8s] font-bold ${
        isVisible ? "left-[0px] opacity-100" : "left-[-100px] opacity-0"
      }`}
    >
      Steps{" "}
...
const HorizontalLine = () => {
  ...
  return (
    ...
    >
      <div
        className={` lg:h-1 w-[2px] delay-[0.7s] duration-200  ${isVisible ? "opacity-100 lg:w-full h-full " :"lg:w-0 h-0"} `}
        style={{
          background:
